    ...
    class SimpleScrollGrid extends BaseComponent {
        ...
        renderChunkTd(sectionConfig, microColGroupNode, chunkConfig, isHeader) {
            ...
            return h(isHeader ? 'th' : 'td', {
                ...
                h(Scroller, { ref: this.scrollerRefs.createRef(sectionKey), elRef: this.scrollerElRefs.createRef(sectionKey), overflowY: overflowY, overflowX: !props.liquid ? 'visible' : 'hidden' /* natural height? */, maxHeight: sectionConfig.maxHeight, liquid: isLiquid, liquidIsAbsolute : true }, content)));
        }
    ...
    function renderInnerContent$1(innerProps) {
        return (h("div", { className: "fc-event-main-frame" },
            ...
            h("div", { className: "fc-event-title-container" },
                h("div", { className: "fc-event-title fc-sticky fc-sticky2" }, innerProps.event.title || h(p, null, "\u00A0")))));
    }
